$(function () {
	...
	checkboxes.click(function () {
		...
		var that = $(this),					//store checkbox variable in variable named that
			specName = that.attr('name');			//store attribute name in global variable specName

		// When a checkbox is checked we need to write that in the filters object created at top of this function;
		if(that.is(":checked"))
		{
